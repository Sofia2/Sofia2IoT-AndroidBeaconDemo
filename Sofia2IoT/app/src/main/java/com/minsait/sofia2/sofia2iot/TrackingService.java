package com.minsait.sofia2.sofia2iot;
...
public class TrackingService extends Service implements LocationListener, GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener, SensorEventListener{
    ...
    private final String Sofia2BeaconMAC = "C7:8D:5D:2E:D8:E6";
            ...
            new BluetoothAdapter.LeScanCallback() {
                ...
                public void onLeScan(final BluetoothDevice device, int rssi, byte[] scanRecord) {
                    Log.i(TAG,device.getAddress());
                            if(device.getAddress().equals("C7:8D:5D:2E:D8:E6") && !FOUND_FLAG && (rssi > -90)){
                                Log.i(TAG,"Found!");
                                FOUND_FLAG = true;
                                pushBeaconData();
                            }
    ...
    private void insertFrameSofia2(final String frame){
